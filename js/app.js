...
$form.addEventListener('submit', (e) => {
    const myURL = `http://api.weatherapi.com/v1/forecast.json?key=6081ec43a3104e0a85f214237232103&q=${$input.value}&days=3`;
    makeRequest(myURL)
...
async function position() {
    ...
    const positionRequest
        = `http://api.weatherapi.com/v1/forecast.json?key=6081ec43a3104e0a85f214237232103&q=${pos.coords.latitude},${pos.coords.longitude}&days=3`;
    makeRequest(positionRequest)
}

makeRequest(localStorage.getItem('url')
    || `http://api.weatherapi.com/v1/forecast.json?&key=6081ec43a3104e0a85f214237232103&days=3&q=Gent`);
